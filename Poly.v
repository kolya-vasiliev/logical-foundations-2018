...
Proof. intros X l1 l2. induction l1 as [|h l1 IH].
  - reflexivity. 
  - simpl. rewrite IH. reflexivity. Qed.
...
Proof. intros X Y f l1 l2. induction l1 as [|h l1 IH].
  - reflexivity.
  - simpl. rewrite IH. reflexivity. Qed.

Theorem map_rev : forall (X Y : Type) (f : X -> Y) (l : list X),
  map f (rev l) = rev (map f l).
Proof. intros X Y f l. induction l as [|h l IH].
  - reflexivity. 
  - simpl. rewrite map_concat, IH. reflexivity. Qed. 
...
Compute map' nat bool oddb [1;2;3;4].
Compute filter' nat oddb [1;2;3;4].
...
Definition forallb {X : Type} (P:X->bool) (l: list X) : bool :=
  fold (fun x => fun y => andb (P x) y)  l true. 

Example forallb_oddb_test1:
  forallb oddb [1;3;5;7] = true.
Proof. reflexivity. Qed.

Example forallb_oddb_test2:
  forallb oddb [1;2;5;7] = false.
Proof. reflexivity. Qed.
